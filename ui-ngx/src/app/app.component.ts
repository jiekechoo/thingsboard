...
export class AppComponent implements OnInit {
  ...
  constructor(private store: Store<AppState>,
    ...
    console.log(`YiSERVER Version: ${env.tbVersion}`);
    ...
    this.matIconRegistry.addSvgIconLiteral(
      'yiqisoft-logo',
      this.domSanitizer.bypassSecurityTrustHtml(
        '<svg viewbox="0 0 200 200"><g stroke-width="12"><path stroke="#333" fill="none" d="M100 91v70M55.216 28.019 93.784 73.98m50.178-45.078-37.924 45.196"/><circle cy="81" cx="100" stroke="red" fill="#fff" r="12"/><circle cy="21" cx="50" stroke="#005fbf" fill="#fff" r="12"/><circle cy="21" cx="150" stroke="#00bf00" fill="#fff" r="12"/><circle cy="173" cx="100" stroke="#ff7f00" fill="#fff" r="12"/></g></svg>'
      )
    );
